          ...
          <div className="max-w-md mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="mt-2 text-muted-foreground">
                Sign in to access your ReadVault account
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl border border-border shadow-sm">
              ...
              <div className="relative mt-8 pt-8 border-t border-border">
                <p className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white px-4 text-xs text-muted-foreground">
                  Or continue with
                </p>
